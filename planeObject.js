...
PlaneObject.prototype.updateIcon = function() {
	// console.log('ICAO: '+this.icao + ',Speed:  ' + this.speed+ ',Alt:  ' + this.altitude);
...
// 		console.log('ICAO: '+this.icao + ',Speed:  ' + this.speed+ ',Alt:  ' + this.altitude);
        ...
        if (baseMarker.noRotate) {
			...
			var labelText = '';
			labelText = (this.flight ? ''+this.flight : 'No Call') + '\n';
			if (this.altitude === 'ground') {
				labelText = 'Alt: ground \n';
			}
			else if (this.altitude) {
				labelText = 'Alt: ' + this.altitude + '\n';
			}
			else {
				labelText = 'Alt: ?\n';
			}
			if (this.speed) {
				labelText = labelText  + 'Speed: ' + this.speed + '\n';
			}
			else {
				labelText = labelText  + 'Speed: 0' + '\n';
			}
                        if (this.track){
                                labelText = labelText  + 'Heading: ' + this.track;
                        }
                        else {
                                labelText = labelText  + 'Heading: ?\n';
                        }
			//labelText     = labelText +'ICAO: '+this.icao ;
			//labelText     = labelText +'Alt: '+ (this.altitude ? parseInt(this.altitude/100) : '?');
			this.markerStyle = new ol.style.Style({
				text: new ol.style.Text({
					text: labelText ,
                    fill: new ol.style.Fill({color: 'yellow'}),
                    stroke: new ol.style.Stroke({color: this.labelColour, width: 10}),
                    textAlign: 'left',
                    textBaseline: "bottom",
			...
			labelText     = (this.flight ? ''+this.flight : 'No Call') + '\n';
			if (this.altitude === 'ground') {
				labelText = labelText  + 'Alt: ground \n';
			}
			else if (this.altitude) {
				labelText = labelText  + 'Alt: ' + this.altitude + '\n';
			}
			else {
